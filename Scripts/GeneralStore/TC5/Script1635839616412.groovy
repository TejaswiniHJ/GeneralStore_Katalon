...
Mobile.tap(findTestObject('Object Repository/android.widget.EditText - Enter name here (1)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Enter name here (2)'), 'tetsr', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.RadioButton - Female (1)'), 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Lets  Shop (2)'), 0)
...
Mobile.clearText(findTestObject('Object Repository/android.widget.ImageView'), 0)
